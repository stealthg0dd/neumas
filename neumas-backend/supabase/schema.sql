...
-- Lightweight daily valuation for command-center trend charts.
-- ---------------------------------------------------------------------------
...
ALTER TABLE inventory_value_snapshots ENABLE ROW LEVEL SECURITY;
...
-- MARKETING CMS
-- =============================================================================
-- Lightweight public marketing content tables. Public reads fail closed through
-- approved_for_public policies; admin writes are handled by backend admin routes
-- using the service-role Supabase client after application-level admin checks.
